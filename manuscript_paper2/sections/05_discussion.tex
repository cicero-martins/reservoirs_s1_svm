...
Rosamarina makes the case concretely: its gauge flat-lined at its telemetry floor
($145.72$~m) for ${\sim}10$ months of 2024--2025, and only the SWOT level ---
corroborated by the optical masks --- recovered the true ${\sim}17$~m drawdown,
without which the optical reconstruction collapsed to a flat, unphysical surface
(Section~\ref{sec:res_xsensor}). For this specific reservoir, the satellite source was
...
diverge ($5.5$~m) at the low-A/P Ancipa. This divergence fell from $6.9$~m once a
reconstruction defect that had collapsed Ancipa's near-dam pool was corrected, but it
did not close, consistent with a genuine A/P-driven ceiling on reconstruction quality
rather than a leftover artifact of that bug. It is also unlikely to be a classifier
...
Two independent lines of evidence --- degraded SWOT water level and PlanetScope
cross-sensor divergence --- therefore converge on the same low-A/P reservoir, so A/P
offers an a-priori screen for where the fully remote pipeline can be trusted.
...
as a partially-correctable systematic with a $\sim\pm10$~pp transfer uncertainty rather
